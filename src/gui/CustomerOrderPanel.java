...
public class CustomerOrderPanel extends JPanel {
    ...
    public CustomerOrderPanel(AppData data) {
        this.data = data;
            ...
            if (serviceNode != null) {
                ...
                if (!qtyText.isEmpty()) {
                    try {
                        ...
                        JOptionPane.showMessageDialog(this, "Anda memesan: " + serviceNode.nameService + " (" + serviceNode.serviceType + ") dengan jumlah " + quantity, "Pesanan Diterima", JOptionPane.INFORMATION_MESSAGE);
                        //Masukkan orderan ke order list
                        data.orderList.createOrder(data.currentCustomer.id, serviceNode.nameService, serviceNode.price, serviceNode.serviceType, (int) quantity);
